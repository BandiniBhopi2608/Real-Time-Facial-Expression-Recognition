# I chose Convolutional neural network to build my model architecture.
# Briefly this architecture contain an input layer, some convolutional layers, some dense layers and output layer.
import os, sys
